...
import { Plus, Trash2, Users, Target, FileText, CheckCircle, XCircle, ShieldCheck, Clock, Trophy, Megaphone, Edit, Award, Image, Mail, MessageSquare, ShieldAlert, BarChart3, Loader2 } from "lucide-react";
...
const Admin = () => {
  ...
  // OPTIMIZATION: Added loading state
  ...
  const updateChallenge = async () => {
    ...
    const { error } = await supabase
      ...
      .update({
        ...
        hints: hintsArray,
        hint_costs: costsArray,
        // FIX: Ensure files is always an array to prevent crash
        files: Array.isArray(editingChallenge.files) ? editingChallenge.files : [],
      })
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {isLoading ? (
          <div className="flex flex-col items-center justify-center py-20">
            ...
            <p className="text-muted-foreground font-mono">Loading admin data...</p>
          </div>
        ) : (
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <ChallengeFileUpload
                            ...
                            existingFiles={Array.isArray(editingChallenge.files) ? editingChallenge.files : []}
                      ...
                      <div key={u.id} className="px-6 py-4 flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 rounded-full bg-primary/20 flex items-center justify-center font-bold text-primary">
                            {/* FIX: Crash prevention for null usernames */}
                            {(u.username?.[0] || "?").toUpperCase()}
                          </div>
                          <div>
                            <div className="font-mono font-semibold">{u.username || "Unknown User"}</div>
